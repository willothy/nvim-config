local function cmp_opt()
    ...
    return {
        ...
        sources = cmp.config.sources({
            ...
            { name = 'nvim_lsp',   priority = 1, max_item_count = 8 },
            { name = 'nvim_lua',   priority = 2, max_item_count = 8 },
            { name = 'luasnip',    priority = 2, max_item_count = 8 },
            { name = 'path',       priority = 2, max_item_count = 8 },
            { name = 'nerdfont',   priority = 3, max_item_count = 8 },
            { name = 'calc',       priority = 3, max_item_count = 8 },
            { name = 'dictionary', priority = 2, max_item_count = 8, keyword_length = 2 },
        }),
        formatting = {
